                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside text-black-200/65 pl-4">
                            ...
                            <li>
                                Job title and employment-related information
                            </li>
                            <li>
                                Browsing data like IP addresses and pages
                                visited
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside text-black-200/65 pl-4">
                            ...
                            <li>Improve Site content and administration</li>
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside text-black-200/65 pl-4">
                            ...
                            <li>
                                Corporate entities during mergers or
                                acquisitions
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="list-none text-black-200/65 pl-0">
                            ...
                            <li>
                                <strong>Website:</strong> www.theajai.com
                            </li>
                            <li>
                                <strong>Email:</strong> legal@theajai.com
                            </li>
                            <li>
                                <strong>Phone:</strong> +91 7776082238
                            </li>
                        </ul>
                    </div>
                </div>

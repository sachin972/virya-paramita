                ...
                <div className="pb-12 md:pb-20">
                    ...
                    <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
                        ...
                        <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.yellow.200),theme(colors.gray.50),theme(colors.yellow.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-black md:text-4xl">
                            Get the glimpse of chosing us over others
                        </h2>
                        <p className="text-lg text-black">
                            Backed by a skilled team and under 10+ years of
                            experienced leadership, VPE paves way in providing
                            clean energy solutions that are feasible,
                            ...
                            <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-yellow-100">
                                        The company is developing a wave-powered
                                        desalination system to provide fresh
                                        water for coastal communities with
                                        limited access to safe drinking and
                                        sanitation water.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-emerald-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-emerald-950/50 after:via-emerald-950/25 after:to-emerald-950/50">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-yellow-100">
                                        Wave energy technology for desalination
                                        is still in its early stages. VPE's team
                                        is developing sustainable solutions to
                                        harness renewable energy for clean water
                                        access.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-yellow-100">
                                        By 2030, the company will offer bankable
                                        WECs for wave farms supporting
                                        desalination, surveillance, navigation,
                                        communication, and UAV/underwater
                                        charging.
                                    </p>
                                </div>
                            </div>

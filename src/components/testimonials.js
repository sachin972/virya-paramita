...
const testimonials = [
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-10.jpg",
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-7.jpeg",
        clientImg: "../images/client-logo-02.svg",
        name: "Content & Engagement Marketing",
        company: "Samsung",
        content:
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-13.jpeg",
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/Sindhuja%201.jpg",
        clientImg: "../images/client-logo-03.svg",
        name: "Media Planning & Analytics",
        company: "Rio",
        content:
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-16.jpeg",
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja%20-12.jpg",
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-15.jpg",
    ...
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja-14.jpeg",
    ...
    // Industries
    {
        img: "https://viryaparamita.onrender.com/img/portfolio/sindhuja%204.jpg",
            ...
            <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
                ...
                <div className="mx-auto max-w-3xl pb-12 text-center">
                    ...
                    <p className="text-lg text-blue-900/90">
                        ...
                        passionately. And no one who hinders endures under
                        another’s name. Because it is pleasing to be in this
                        official duty indeed here.
                    </p>
                </div>
...
//     return (
//         <article
//             className={`relative rounded-2xl bg-gradient-to-br from-gray-900/60 via-gray-800/40 to-gray-900/60 p-2 shadow-lg backdrop-blur-md transition-opacity hover:scale-105 hover:shadow-2xl before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-gray-700/50 before:[background:linear-gradient(to_right,rgba(40,40,40,0.9),rgba(50,50,50,0.8),rgba(40,40,40,0.9))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${
...
export function Testimonial({ testimonial, category }) {
    const [show, setShow] = useState(false);
        ...
        >
            ...
            <Link to="/iew-2025">
                <img
                    ...
                    src={testimonial.img}
                    alt={testimonial.name}
                    // onClick={() => setShow(true)} // Opens dialog on click
                />
            </Link>
            ...
            <Dialog open={show} onClose={() => setShow(false)}>
                ...
                <div className="fixed inset-0 z-[99999] flex items-center justify-center">
                    <DialogPanel className="relative w-full h-full overflow-hidden bg-black">
                        {/* Close Button */}
                        <button
